...
export function App() {
  ...
  const handleCreateSession = async (name: string, cwd: string, skipPermissions: boolean, pullLatest: boolean) => {
    setIsModalOpen(false);
    await createSession(name, cwd, skipPermissions, pullLatest);
  };
